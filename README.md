...
| 项目 (Project) | 类别 (Category) | 核心说明 (Overview) | 传送门 (Portal) |
| :--- | :--- | :--- | :---: |
| 🚀 **AlphaFDE** | `主要项目`<br>`Flagship Platform` | 专注于企业级 AI 智能体数字化转型、Forward Deployed Engineer 驻场交付与 ANC 商业工作流落地。 | [![Official Site](https://img.shields.io/badge/Website-alphafde.cn-58A6FF?style=flat-square&logo=googlechrome&logoColor=white)](https://alphafde.cn) |
