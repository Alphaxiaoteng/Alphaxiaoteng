...
<p align="center">
  <a href="https://cpt1024.blog.csdn.net" target="_blank"><img src="https://img.shields.io/badge/CSDN-博客专家-FC5531?style=for-the-badge&logo=csdn&logoColor=white"/></a>
...
| 📜 **Hermes Agent** | `Architect`<br>`AIGC Script` | 自进化短视频文案架构，基于大模型深度解构爆款视频、重构口播脚本与全自动产出。 | [![Demo](https://img.shields.io/badge/Demo-WorkShow-4ECDC4?style=flat-square&logo=visualstudiocode&logoColor=white)](https://github.com/Alphaxiaoteng/WorkShow) |
| 📐 **AI Coding Rules** | `Creator`<br>`DevTools` | 工业级 AI 辅助编程规范与 Cursor / Antigravity 指令工程最佳实践。 | [![Rules](https://img.shields.io/badge/Rules-Matrix-9B5DE5?style=flat-square&logo=gitbook&logoColor=white)](https://github.com/Alphaxiaoteng) |
